...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(avy-lead-face ((t (:background "#282B35" :foreground "magenta"))))
 '(avy-lead-face-0 ((t (:background "#282B35" :foreground "red")))))
